...
namespace projekt1
{
    public partial class Form1 : Form
    {
        ...
        private void wczytajWlasneToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void kolor1ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.BackColor = SystemColors.Control;
            this.BackgroundImage = null;
        }

        private void kolor2ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void button7_KeyPress(object sender, KeyPressEventArgs e)
        {
            switch (e.KeyChar)
            {
                ...
                case '+':
                    ...
                    break;
                case '-':
                    this.buttonMinus_Click(sender, e);
                    break;
                case '*':
                    this.buttonMn_Click(sender, e);
                    break;
                case '/':
                    this.buttonDz_Click(sender, e);
                    break;
                case '=':
                    this.buttonEq_Click(sender, e);
                    break;
                case (char)8:
                    this.txtWynik.Text = this.txtWynik.Text.Remove(this.txtWynik.Text.Length - 1, 1);
                    break;
                /*case (char)13:
                    //this.buttonEq_Click(sender, e);
                    break;*/
